...
(async () => {
    ...
    if (sites.length===0){
        ...
        await SoundEffect.create({
            siteID: fayetteParkSitePage.siteID,
            name: "Frederick Douglass speech excerpt",
        ...
        await SoundEffect.create({
            siteID: cityHallSitePage.siteID,
            name: "Matilda Joslyn Gage speech excerpt",
